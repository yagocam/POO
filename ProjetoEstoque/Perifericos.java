...
public class Perifericos extends Produto  implements Garantia
{
    public  Perifericos(){};
    public Perifericos(String nome, double preco,int q)
    {
        setNome(nome);
        setPreco(preco);
        setQuantidade(q);
    ...
    public void exibir()
    {
        System.out.println("O periférico "+getNome()+" custa: "+getPreco());
        garantia();
    }
